...
const char * LIB_PATH_VALUE   = "C:\\Users\\phoebe\\jpegtran\\.libs;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "C:\\Users\\phoebe\\jpegtran\\.libs;C:\\Users\\phoebe\\scoop\\apps\\git\\2.42.0.2\\usr\\local\\lib;C:\\Users\\phoebe\\scoop\\apps\\git\\2.42.0.2\\usr\\local\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"jpegtran.exe:jpegtran:$LINENO: libtool wrapper (GNU libtool) 2.4.6 De", f);
  fputs ("bian-2.4.6-2\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("    PATH=/c/Users/phoebe/jpegtran/.libs:/usr/local/lib:/usr/local/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/c/Users/phoebe/jpegtran/.libs:$PATH\"\n", f);
  fputs ("\n", f);
